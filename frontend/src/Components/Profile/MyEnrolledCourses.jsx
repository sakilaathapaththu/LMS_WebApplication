...
import { School, Person, Schedule, TrendingUp, CheckCircle, MenuBook } from "@mui/icons-material";
...
const MyEnrolledCourses = () => {
  ...
  const approvedCourses = useMemo(
    () => courses.filter((c) => c?.isApproved === true),
    [courses]
  );
  ...
  // Empty state for NO APPROVED courses
  if (approvedCourses.length === 0) {
    return (
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: "#546e7a" }}>
          If you’ve requested enrollments, they may still be pending approval.
        </Typography>
      </Box>
    );
  }
    ...
    <Container maxWidth="xl" sx={{ mt: 5, mb: 6 }}>
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
          ...
          <Typography
            variant="h4"
            sx={{ color: "#1565c0", fontWeight: 700, letterSpacing: "-0.5px" }}
          >
            My Approved Courses
          </Typography>
        </Box>
        <Typography variant="body1" sx={{ color: "#546e7a", ml: 7 }}>
          Continue learning from your approved enrollments
        </Typography>
      </Box>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 4, mb: 6 }}>
        {approvedCourses.map((course) => (
          <Paper
            ...
            onKeyDown={(e) => e.key === "Enter" && handleOpenCourse(course._id)}
            sx={{
              p: 4,
              borderRadius: 3,
              background: "linear-gradient(135deg, #ffffff 0%, #f8fbff 100%)",
          ...
          >
            ...
            >
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                ...
                <Typography
                  variant="body1"
                  sx={{ color: "#546e7a", mb: 3, lineHeight: 1.6 }}
                >
      ...
      >
        <Typography variant="h6" sx={{ color: "#1565c0", fontWeight: 500 }}>
          You have {approvedCourses.length} approved course{approvedCourses.length !== 1 ? "s" : ""}
        </Typography>
        <Typography variant="body2" sx={{ color: "#546e7a", mt: 1 }}>
